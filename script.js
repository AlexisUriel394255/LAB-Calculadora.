...
function suma(a,b){
  return a+b; /*aqui le pido que me haga la suma 
...
function multiplicacion(a,b){
   return a*b /*aqui se hara la operacion que es la multiplicacion entre los 
dos valores*/
} 
...
function dividir(a,b){
 return a / b; /*Aqui se hara la division de los dos valores adentro de la
funcion*/
}
...
function resta(a,b){
 return a-b; /*Ahora se hace la operacion de restar a menos b adentro de 
la funcion*/
}
